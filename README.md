...
| `FMSG_API_JWT_SECRET` | *(required)*           | HMAC secret used to validate JWT tokens. If the value is valid base64 it is decoded to bytes; otherwise the raw string is used. |
